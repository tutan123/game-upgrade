...
internal static class CSteamAPIContext
{
	...
	internal static bool Init()
	{
		...
		using (InteropHelp.UTF8StringHandle ver = new InteropHelp.UTF8StringHandle("SteamClient023"))
		{
		...
		m_pSteamUser = SteamClient.GetISteamUser(hSteamUser, hSteamPipe, "SteamUser023");
		if (m_pSteamUser == IntPtr.Zero)
		{
			return false;
		}
		m_pSteamFriends = SteamClient.GetISteamFriends(hSteamUser, hSteamPipe, "SteamFriends018");
		...
		m_pSteamUserStats = SteamClient.GetISteamUserStats(hSteamUser, hSteamPipe, "STEAMUSERSTATS_INTERFACE_VERSION013");
		...
		m_pSteamUGC = SteamClient.GetISteamUGC(hSteamUser, hSteamPipe, "STEAMUGC_INTERFACE_VERSION021");
		...
		m_pSteamVideo = SteamClient.GetISteamVideo(hSteamUser, hSteamPipe, "STEAMVIDEO_INTERFACE_V007");
		...
		m_pSteamRemotePlay = SteamClient.GetISteamRemotePlay(hSteamUser, hSteamPipe, "STEAMREMOTEPLAY_INTERFACE_VERSION003");
		...
		using (InteropHelp.UTF8StringHandle pszVersion4 = new InteropHelp.UTF8StringHandle("STEAMTIMELINE_INTERFACE_V004"))
		{
			m_pSteamTimeline = NativeMethods.SteamInternal_FindOrCreateUserInterface(hSteamUser, pszVersion4);
		}
		if (m_pSteamTimeline == IntPtr.Zero)
		{
			return false;
		}
		return true;
