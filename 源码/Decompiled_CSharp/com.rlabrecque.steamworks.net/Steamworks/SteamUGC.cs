...
public static class SteamUGC
{
	...
	{
		InteropHelp.TestIfAvailableClient();
		using InteropHelp.UTF8StringHandle pszGameBranchMin2 = new InteropHelp.UTF8StringHandle(pszGameBranchMin);
		using InteropHelp.UTF8StringHandle pszGameBranchMax2 = new InteropHelp.UTF8StringHandle(pszGameBranchMax);
