...
public class JsonMapper
{
	...
	public static string ToJson(object obj)
	{
		lock (static_writer_lock)
		{
			...
			{
				Console.Error.WriteLine("[JsonMapper] ToJson(object) Error, object type: " + obj.GetType());
				throw;
			}
		}
	}
	...
	public static void ToJson(object obj, JsonWriter writer)
	{
		...
		{
			Console.Error.WriteLine("[JsonMapper] ToJson(object, JsonWriter) Error, object type: " + obj.GetType());
			throw;
		}
	}
	...
	public static JsonData ToObject(JsonReader reader)
	{
		...
		{
			Console.Error.WriteLine("[JsonMapper] ToObject(JsonReader) Error");
			throw;
		}
	}
	...
	public static JsonData ToObject(TextReader reader)
	{
		...
		{
			Console.Error.WriteLine("[JsonMapper] ToObject(TextReader) Error");
			throw;
		}
	}
	...
	public static JsonData ToObject(string json)
	{
		...
		{
			Console.Error.WriteLine("[JsonMapper] ToObject(string) Error, json:" + json);
			throw;
		}
	}
	...
	public static T ToObject<T>(JsonReader reader)
	{
		...
		{
			Console.Error.WriteLine("[JsonMapper] ToObject<T>(JsonReader) Error, object type: " + typeof(T));
			throw;
		}
	}
	...
	public static T ToObject<T>(TextReader reader)
	{
		...
		{
			Console.Error.WriteLine("[JsonMapper] ToObject<T>(TextReader) Error, object type: " + typeof(T));
			throw;
		}
	}
	...
	public static T ToObject<T>(string json)
	{
		...
		{
			Console.Error.WriteLine("[JsonMapper] ToObject<T>(string) Error, object type: " + typeof(T)?.ToString() + ", json: " + json);
			throw;
		}
	}
	...
	public static object ToObject(string json, Type ConvertType)
	{
		...
		{
			Console.Error.WriteLine("[JsonMapper] ToObject(string, Type) Error, object type: " + ConvertType?.ToString() + ", json: " + json);
			throw;
		}
	}
