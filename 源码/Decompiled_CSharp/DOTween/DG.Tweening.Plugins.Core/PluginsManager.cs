...
internal static class PluginsManager
{
	...
	internal static ABSTweenPlugin<T1, T2, TPlugOptions> GetDefaultPlugin<T1, T2, TPlugOptions>() where TPlugOptions : struct, IPlugOptions
	{
		...
		if ((object)typeFromHandle == typeof(Vector3) && (object)typeFromHandle == typeFromHandle2)
		{
		...
		else if ((object)typeFromHandle == typeof(Vector3) && (object)typeFromHandle2 == typeof(Vector3[]))
		{
		...
		else if ((object)typeFromHandle == typeof(Quaternion))
		{
			if ((object)typeFromHandle2 == typeof(Quaternion))
			{
		...
		else if ((object)typeFromHandle == typeof(Vector2))
		{
		...
		else if ((object)typeFromHandle == typeof(Vector4))
		{
		...
		else if ((object)typeFromHandle == typeof(Rect))
		{
			if (_rectPlugin == null)
			{
		...
		else if ((object)typeFromHandle == typeof(RectOffset))
		{
		...
		else if ((object)typeFromHandle == typeof(Color2))
		{
