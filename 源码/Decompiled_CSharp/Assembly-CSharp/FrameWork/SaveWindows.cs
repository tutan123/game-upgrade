...
[ActorInfo("", "SaveWindows")]
[UiMode(Mode.Normal, false)]
public class SaveWindows : UiActor
{
	...
	public SaveWindows(Transform trans)
		: base(trans)
	{
	}
	...
	public void InitType(bool isLoad = true, Action action = null, bool isInit = false)
	{
		...
		IEnumerator CreateSaveData()
		{
			if (!isInit)
			{
				Sprite sprite = ABMrg.Load<Sprite>("SaveIcon");
				Tool.ShowTutorial("SaveWindows", new Sprite[1] { sprite });
			}
